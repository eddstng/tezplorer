...
export async function getAddressOperations(address: string) {
    ...
    // If no error, add all operations into an array and sort them by block level and hash. 
